...
echo '</div></div>';
echo '<br><br><br>';
echo '<h1 class="ctitle">Melléknév-gyakorisági táblázat</h1>';
echo '<br>';
echo '<div><div>';
echo '<table class="table"><thead><tr><th>Szó</th><th>Gyakoriság</th></tr></thead>';
echo '<tr><td>'. $decodedJson[51]. '</td>';
echo  '<td>' . $decodedJson[52] . '</td></tr>';
echo '<tr><td>'. $decodedJson[53]. '</td>';
echo  '<td>' . $decodedJson[54] . '</td></tr>';
echo '<tr><td>'. $decodedJson[55]. '</td>';
echo  '<td>' . $decodedJson[56] . '</td></tr>';
echo '<tr><td>'. $decodedJson[57]. '</td>';
echo  '<td>' . $decodedJson[58] . '</td></tr>';
echo '<tr><td>'. $decodedJson[59]. '</td>';
echo  '<td>' . $decodedJson[60] . '</td></tr>';
echo '</table>';
echo '</div></div>';
